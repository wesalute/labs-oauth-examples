...
let scope = 'openid offline email profile consumer.audience consumer.tier consumer.household';
...
export function getRedirect(host, client_id, premium, verify) {
  ...
  // Adjust the scopes (remove consumer.household) for the strabucks client
  if (client_id == "starbucks") {
